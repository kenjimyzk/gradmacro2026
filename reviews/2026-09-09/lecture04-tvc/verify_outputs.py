#!/usr/bin/env python3
"""Static checks for Lecture 04 after restoring the transversality equation; no browser is used."""
...
print('Verified static HTML references/assets, PDF text, and display-math delimiters for Lecture 04.')
