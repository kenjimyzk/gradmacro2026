...
grDevices::cairo_pdf("/Users/kenjimyzk/work/gradmacro2026/reviews/2026-09-09/rereview/r-runtime/lecture09-fresh.pdf", width=8, height=6.3, family=jp_probe$family)
...
invisible(dev.off())
stopifnot(max(abs(A %*% x_C-b))<1e-12,max(abs(kappa_x*omega_p*pi_C+c(x_C[1]-x_lag,diff(x_C))))<1e-12)
capture.output(sessionInfo(),file="/Users/kenjimyzk/work/gradmacro2026/reviews/2026-09-09/rereview/r-runtime/lecture09-session.txt")
saveRDS(as.list(.GlobalEnv),file="/Users/kenjimyzk/work/gradmacro2026/reviews/2026-09-09/rereview/r-runtime/lecture09-objects.rds")
