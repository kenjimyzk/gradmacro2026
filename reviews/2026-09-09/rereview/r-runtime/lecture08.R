...
grDevices::cairo_pdf("/Users/kenjimyzk/work/gradmacro2026/reviews/2026-09-09/rereview/r-runtime/lecture08-fresh.pdf", width=8, height=6.3, family=jp_probe$family)
...
par(op)
invisible(dev.off())
capture.output(sessionInfo(),file="/Users/kenjimyzk/work/gradmacro2026/reviews/2026-09-09/rereview/r-runtime/lecture08-session.txt")
saveRDS(as.list(.GlobalEnv),file="/Users/kenjimyzk/work/gradmacro2026/reviews/2026-09-09/rereview/r-runtime/lecture08-objects.rds")
