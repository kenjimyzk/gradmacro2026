#!/usr/bin/env python3
"""Static checks for the all thirteen saved documents; no browser is used."""
...
ROOT = OUT.parents[2]
NAMES = [f'lecture{n:02}' for n in range(1, 13)] + ['solution']
...
print('Verified static HTML references/assets, PDF text, and display-math delimiters for thirteen documents.')
