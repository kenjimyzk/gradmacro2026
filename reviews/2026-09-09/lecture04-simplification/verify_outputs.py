#!/usr/bin/env python3
"""Static checks for the two documents rebuilt after simplifying Lecture 04; no browser is used."""
...
print('Verified static HTML references/assets, PDF text, and display-math delimiters for two rebuilt documents.')
