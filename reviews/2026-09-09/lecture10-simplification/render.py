"""Rebuild Lectures 01 and 10 and its synchronized exercise solutions after simplification."""
...
names = sys.argv[1:] or ['lecture01', 'lecture09', 'lecture10', 'solution']
assert set(names) <= {'lecture01', 'lecture09', 'lecture10', 'solution'}
