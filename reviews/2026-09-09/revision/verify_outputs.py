#!/usr/bin/env python3
"""Static checks for the five lectures rebuilt after the September 9 rereview; no browser is used."""
...
ROOT = OUT.parents[2]
NAMES = ['lecture03', 'lecture05', 'lecture10', 'lecture11', 'lecture12']
...
print('Verified static HTML references/assets, PDF text, and display-math delimiters for five rebuilt documents.')
