...
*Notes:* 第3回から第7回までの部品を RANKモデルに統合し、自然産出量、自然利子率、需給ギャップ、3本のニューケインジアン方程式へ整理する。
...
- Galí, Jordi (2015) *Monetary Policy, Inflation, and the Business Cycle* (2nd ed.). Princeton University Press. 第3章を参照。RANKモデル、自然利子率、需給ギャップの標準的教科書。
...
- Schmitt-Grohé, Stephanie, and Martín Uribe (2004) "Solving Dynamic General Equilibrium Models Using a Second-Order Approximation to the Policy Function." *Journal of Economic Dynamics and Control*, 28(4), 755-775. [doi](https://doi.org/10.1016/S0165-1889(03)00043-5). 本講義の一次近似と未定係数法から、一般のDSGEモデルの二次近似法へ進むための発展文献。
...
**問5 [Research extension] [Derivation]：政府支出ショック**
...
**問6 [Research extension] [Derivation]：厚生ロスへの接続**
