...
第8回の RANK モデルでは、独占的競争、価格硬直性、金融政策を導入します。その前に、資本も価格硬直性もない環境で、次の3点を確認します。

1. 家計の労働供給条件と企業の労働需要条件
2. 資源制約と生産関数からなる静学的均衡
3. 技術ショックに対する対数線形近似解
...
\end{aligned}
$$
第1式は労働供給条件です。実質賃金は、消費の限界効用で測った労働の限界不効用、すなわち限界代替率に等しくなります。第2式は Euler 方程式、第3式は株式価値の無裁定条件です。
...
W_t=A_tF_N(N_t)
$$
です。完全競争では、実質賃金は労働の限界生産物に等しくなります。

家計の労働供給条件と企業の労働需要条件を合わせると
$$
-\frac{U_{N,t}}{U_{C,t}}=A_tF_N(N_t)
$$
を得ます。この式が、資本なし RBC モデルの中心です。左辺は労働供給側の限界代替率、右辺は労働需要側の限界生産物です。
